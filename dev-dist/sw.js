...
define(['./workbox-caf3a6a6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/mykokprjxrzapvokvcjg\.supabase\.co\/rest\/v1\/(products|categories|services|settings).*/i, new workbox.NetworkFirst({
